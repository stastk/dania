...
func ExecDB(action string) (string, error) {
	if action == "init" {
		...
		tx.MustExec(`
			...
			VALUES 
				(1, 6, 11, 'Goat milk',  10, 1, 'g'),
				(1, 5, 14, 'Stevia',  1, 2, 'kg'),
				(1, 4, 15, 'Big onion',  2, 3, 'l'),
				(1, 3, 7, 'Chilli pepper',  1, 4, 'lb'),
				(1, 2, 3, 'Salt of the sea',  4, 5, 'piece'),
				(2, 1, 1, 'Ganash of the north',  100, 1, 'g'),
				(2, 2, 3, 'Salt of the sea',  3, 2, 'kg'),
				(2, 3, 7, 'Chilli pepper',  13, 3, 'l'),
				(2, 4, 15, 'Big onion',  100, 4, 'lb'),
				(2, 5, 17, 'Just glass, not a sugar',  33, 5, 'piece'),
				(3, 6, 12, 'Milk powder',  4000, 1, 'g'),
				(4, 1, 2, 'Ganash of the south',  200, 2, 'kg'),
				(4, 2, 3, 'Salt of the sea',  10, 3, 'l'),
				(5, 3, 7, 'Chilli pepper',  2, 4, 'lb'),
				(5, 4, 16, 'Purple TOR onion',  5, 5, 'piece'),
				(5, 5, 13, 'Natural sugar',  6, 1, 'g'),
				(5, 6, 12, 'Milk powder',  2000, 2, 'kg'),
				(5, 5, 17, 'Just glass, not a sugar',  10, 3, 'l'),
				(5, 4, 15, 'Big onion',  15, 4, 'lb'),
				(5, 3, 7, 'Chilli pepper',  10, 5, 'piece'),
				(5, 2, 3, 'Salt of the sea',  93, 1, 'g'),
				(5, 1, 1, 'Ganash of the north',  100, 2, 'kg'),
				(5, 2, 3, 'Salt of the sea',  450, 3, 'l'),
				(5, 3, 8, 'Pepper',  40, 4, 'lb'),
				(5, 4, 15, 'Big onion',  500, 5, 'piece'),
				(5, 5, 14, 'Stevia',  400, 1, 'g'),
				(6, 6, 12, 'Milk powder',  90, 2, 'kg'),
				(6, 5, 14, 'Stevia',  900, 3, 'l'),
				(6, 4, 16, 'Purple TOR onion',  20, 4, 'lb'),
				(6, 3, 5, 'Pepper of the Iron Man',  48, 5, 'piece'),
				(6, 2, 3, 'Salt of the sea',  600, 1, 'g'),
				(6, 1, 4, 'Ganash of the west',  200, 2, 'kg'),
				(7, 2, 3, 'Salt of the sea',  400, 3, 'l'),
				(7, 3, 7, 'Chilli pepper',  300, 4, 'lb'),
				(7, 4, 15, 'Big onion',  100, 5, 'piece'),
				(8, 5, 14, 'Stevia',  750, 1, 'g'),
				(8, 6, 11, 'Goat milk',  1, 2, 'kg'),
				(8, 1, 2, 'Ganash of the north',  1, 3, 'l'),
				(8, 2, 3, 'Salt of the sea',  1, 4, 'lb'),
				(8, 3, 7, 'Chilli pepper',  1, 5, 'piece'),
				(8, 4, 15, 'Big onion',  60, 2, 'kg'),
				(8, 5, 14, 'Stevia',  85, 3, 'l'),
				(8, 6, 12, 'Milk powder',  35, 4, 'lb'),
				(9, 1, 2, 'Ganash of the north',  110, 5, 'piece'),
				(10, 2, 3, 'Salt of the sea',  25, 2, 'kg'),
				(10, 3, 7, 'Chilli pepper',  92, 1, 'g'),
				(10, 4, 15, 'Big onion',  1, 4, 'lb');
		`)
